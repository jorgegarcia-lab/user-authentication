...
public class Constants {
    ...
    public static final String PASSWORD_LENGTH_ERROR_MESSAGE = "Please enter a correct password length, it should be at least 8 characters and no more than 12";
